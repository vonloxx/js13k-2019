...
export default ({ gameState }) => {
  ...
  nyanCat.state.x = 0;
  nyanCat.setDirection(-1);
  nyanCat.setAnimation('flying');
  // nyanCat.setRotation(-20);
  ...
  return compose(Camera, Scene)({
    ...
    update(props) {
      ...
      setTarget(nyanCat.state.x, nyanCat.state.y);
      ...
      gameState.height = ~~((480 - nyanCat.state.y) / 30);
    ...
    beforeCameraRender(props) {
      ...
      let x = -~~nyanCat.state.x;
      let y = -~~nyanCat.state.y;
      context.sv();
